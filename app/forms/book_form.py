...
class BookForm(FlaskForm):
  ...
  price_paperback = FloatField('Paperback Price', validators=[Optional(), paperback_price_fixer])
  price_hardcover = FloatField('Hardcover Price', validators=[Optional(), hardcover_price_fixer])
  price_eBook = FloatField('eBook Price', validators=[Optional(), eBook_price_fixer])
